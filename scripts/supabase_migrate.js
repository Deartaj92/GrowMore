...
var schemaPath = path.resolve(__dirname, '../supabase_school_schema.sql');
var config = JSON.parse(fs.readFileSync(configPath, 'utf-8'));
console.log('Config loaded:', configPath);
var sql = fs.readFileSync(schemaPath, 'utf-8');
...
function migrate() {
    return __awaiter(this, void 0, void 0, function () {
        var statements, _i, statements_1, stmt, err_1, err_2;
