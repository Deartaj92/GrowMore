...
import DualTypingText from './DualTypingText';
...
const AddStudentButton = muiStyled(Button)(({ theme }) => ({
...
export default function NoStudentsFound({ loading = false }: { loading?: boolean }) {
  ...
  return (
    <CenteredFlex>
      <IconCircle>
        <PeopleOutlineIcon style={{ fontSize: 54, color: theme === 'dark' ? darkTheme.ACCENT : lightTheme.ACCENT }} />
      </IconCircle>
      <DualTypingText />
      <Typography
        variant="h6"
      ...
      >
        There are currently no students in the system. Start by adding your first student to unlock all features like attendance, reports, and more.
      </Typography>
      <AddStudentButton
        size="large"
