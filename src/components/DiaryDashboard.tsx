...
const diaryItems = [
  {
    title: 'Assign Diary',
    description: 'Create, edit, and manage daily homework assignments for classes and subjects with comprehensive tracking',
    icon: <AssignmentIcon />,
    path: '/homework-diary',
    color: '#3b82f6' // Blue
  },
  {
    title: 'Analytics',
    description: 'Analyze homework assignment patterns, completion rates, and performance statistics with interactive dashboards',
    icon: <BarChartIcon />,
  ...
  return (
    <PageContainer theme={theme}>
      <Header>
        ...
        <Subtitle>
          Manage homework assignments and analyze diary performance with comprehensive tracking
        </Subtitle>
      </Header>
