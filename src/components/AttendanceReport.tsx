...
// --- Dashboard-style Skeleton Loading Components for AttendanceReport ---
const AttendanceReportSkeletonContainer = styled.div`
  width: 100%;
  height: 100%;
...
`;
const SkeletonStudentNameCell = styled(SkeletonTableCell)`
  min-width: 120px;
  max-width: 220px;
`;
const SkeletonTableHeader = styled(SkeletonTableCell)`
  ...
  height: 28px;
`;
const skeletonStudentRows = 7;
const skeletonDays = 20;
const AttendanceReportSkeleton: React.FC = () => (
  <AttendanceReportSkeletonContainer>
    <SkeletonFilterBar>
      {[1,2,3,4].map(i => (
