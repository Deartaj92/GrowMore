...
// Enquiry Management menu items
const enquiryManagementItems = [
  {
    title: 'Enquiry Dashboard',
    description: 'Overview of all enquiries with statistics, recent activities, and quick insights into enquiry management performance',
    icon: <DashboardIcon />,
  ...
  {
    title: 'All Enquiries',
    description: 'View and manage all enquiries with advanced filtering, search capabilities, and comprehensive enquiry management tools',
    icon: <ListIcon />,
    path: '/enquiries/list',
    color: '#10b981' // Green
  },
  {
    title: 'New Enquiry',
    description: 'Create new enquiries for admission inquiries, job vacancies, or general information requests with comprehensive forms',
    icon: <AddIcon />,
  ...
  return (
    <PageContainer>
      <Header>
        ...
        <Subtitle>
          Comprehensive enquiry tracking, follow-up management, and admission/job vacancy processing system
        </Subtitle>
      </Header>

      <CardsGrid>
        {enquiryManagementItems.map((item, index) => (
          <Card 
            key={index}
