...
import DualTypingTextClasses from './DualTypingTextClasses';
...
const AddClassButton = muiStyled(Button)(({ theme }) => ({
...
export default function NoClassesFound({ loading = false }: { loading?: boolean }) {
  ...
  return (
    <CenteredFlex>
      ...
      >
        There are currently no classes in the system. Start by adding your first class to organize students and manage academic activities effectively.
      </Typography>
      <AddClassButton
        size="large"
