      ...
      <ProfileHeader>
        ...
        <Box sx={{ flex: 1, position: 'relative', zIndex: 2 }}>
          ...
          <Box sx={{ 
            ...
            {[1, 2, 3].map((i) => (
              <Box key={i} sx={{ display: 'flex', alignItems: 'center', gap: 1.5, p: 1.25, borderRadius: 1 }}>
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={12} sm={6} md={3}>
            <StatCard sx={{ p: 3, height: '100%', display: 'flex', flexDirection: 'column' }}>
              <Box sx={{ position: 'relative', width: '180px', height: '180px', margin: '0 auto', mb: 3 }}>
          ...
          {/* Test Summary Card Skeleton */}
          <Grid item xs={12} sm={6} md={3}>
            <StatCard sx={{ p: 1.5, px: 1.5, height: '100%', display: 'flex', flexDirection: 'column' }}>
              <Box sx={{ position: 'relative', zIndex: 1, width: '100%', height: '100%', display: 'flex', flexDirection: 'column' }}>
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.75, mb: 1.25, flexShrink: 0, width: '100%' }}>
                  <Skeleton variant="circular" width={18} height={18} sx={{ flexShrink: 0 }} />
                  <Skeleton variant="text" height={16} sx={{ flex: 1, minWidth: 0 }} />
                </Box>
                <Box sx={{ flex: 1, minHeight: 0, overflowY: 'auto', width: '100%', display: 'flex', alignItems: 'center' }}>
                  <Stack spacing={1} sx={{ width: '100%' }}>
                    <Box sx={{ py: 1.25, px: 1.25, borderRadius: 1, border: '1px solid', borderColor: 'divider', display: 'flex', alignItems: 'center', gap: 1.25, width: '100%', boxSizing: 'border-box' }}>
                      <Box sx={{ minWidth: '75px', flexShrink: 0 }}>
                        <Skeleton variant="text" width={60} height={20} />
                        <Skeleton variant="text" width={80} height={16} sx={{ mt: 0.25 }} />
                      </Box>
                      <Box sx={{ width: '1.5px', height: '24px', bgcolor: 'divider', flexShrink: 0 }} />
                      <Box sx={{ flex: 1, minWidth: 0 }}>
                        <Skeleton variant="text" width="100%" height={20} />
                        <Skeleton variant="text" width="100%" height={16} sx={{ mt: 0.25 }} />
                      </Box>
                    </Box>
                    <Box sx={{ py: 1.25, px: 1.25, borderRadius: 1, border: '1px solid', borderColor: 'divider', display: 'flex', alignItems: 'center', gap: 1.25, width: '100%', boxSizing: 'border-box' }}>
                      <Box sx={{ minWidth: '75px', flexShrink: 0 }}>
                    ...
                    {[1, 2, 3, 4, 5].map((i) => (
                      <Box key={i} sx={{ py: 0.9, px: 1, borderRadius: 0.875, border: '1px solid', borderColor: 'divider', display: 'flex', alignItems: 'center', gap: 0.75, width: '100%', boxSizing: 'border-box' }}>
                        <Skeleton variant="rectangular" width={36} height={20} sx={{ borderRadius: 0.5, flexShrink: 0 }} />
                        <Box sx={{ width: '1px', height: '18px', bgcolor: 'divider', flexShrink: 0 }} />
                        <Skeleton variant="text" height={16} sx={{ flex: 1, minWidth: 0 }} />
                      </Box>
                    ))}
                  </Stack>
              ...
              <Box sx={{ position: 'relative', zIndex: 1, width: '100%', height: '100%', display: 'flex', flexDirection: 'column' }}>
                ...
                <Box sx={{ flex: 1, minHeight: 0, overflowY: 'auto', width: '100%', display: 'flex', alignItems: 'center' }}>
                  <Stack spacing={1} sx={{ width: '100%' }}>
                    ...
                    <Box sx={{ py: 1, px: 1.25, borderRadius: 1, border: '1px solid', borderColor: 'divider', display: 'flex', alignItems: 'center', gap: 1.25, width: '100%', boxSizing: 'border-box' }}>
                      <Box sx={{ minWidth: '75px', flexShrink: 0 }}>
                        <Skeleton variant="text" width={60} height={20} />
                        <Skeleton variant="text" width={80} height={16} sx={{ mt: 0.25 }} />
                      </Box>
                    ...
                    {[1, 2, 3, 4, 5].map((i) => (
                      <Box key={i} sx={{ py: 0.875, px: 1, borderRadius: 0.75, border: '1px solid', borderColor: 'divider', display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%', boxSizing: 'border-box' }}>
                        <Skeleton variant="text" height={16} sx={{ flex: 1, minWidth: 0 }} />
                        <Skeleton variant="rectangular" width={24} height={20} sx={{ borderRadius: 0.25, flexShrink: 0 }} />
                      </Box>
                    ))}
                  </Stack>
                </Box>
                ...
                <Box sx={{ flex: 1, minHeight: 0, overflowY: 'auto', width: '100%', display: 'flex', alignItems: 'center' }}>
                  <Stack spacing={0.5} sx={{ width: '100%' }}>
                    {[1, 2, 3, 4, 5, 6, 7, 8].map((i) => (
                      <Box key={i} sx={{ py: 0.75, px: 0.875, borderRadius: 0.5, border: '1px solid', borderColor: 'divider', display: 'flex', alignItems: 'center', gap: 0.875, width: '100%', boxSizing: 'border-box', minWidth: 0 }}>
                        <Skeleton variant="text" width={26} height={16} sx={{ flexShrink: 0 }} />
                        <Box sx={{ width: '1px', height: '14px', bgcolor: 'divider', flexShrink: 0 }} />
                        <Skeleton variant="text" width={55} height={14} sx={{ flexShrink: 0 }} />
                        <Box sx={{ width: '1px', height: '14px', bgcolor: 'divider', flexShrink: 0 }} />
                        <Skeleton variant="text" height={14} sx={{ flex: 1, minWidth: 0 }} />
                      </Box>
                    ))}
                  </Stack>
                </Box>
            ...
            <Grid item xs={12} md={6}>
              <InfoSection>
                ...
                <InfoGrid container spacing={2}>
                  {[1, 2, 3, 4, 5, 6].map((i) => (
                    <Grid item xs={12} sm={6} key={i} className="info-item">
