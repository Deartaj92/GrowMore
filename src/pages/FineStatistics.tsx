...
// --- Dashboard-style Skeleton Loader for FineStatistics ---
const FineStatisticsSkeletonContainer = styled.div`
  width: 100%;
  height: 100%;
...
`;
const SkeletonPageTitle = styled.div`
  width: 260px;
  height: 38px;
  background: ${({ theme }) => theme.CARD};
  border-radius: 10px;
...
`;
const SkeletonSmallCardGrid = styled.div`
  display: flex;
  flex-wrap: wrap;
  gap: 1.2rem;
  margin-bottom: 2rem;
...
`;
const SkeletonLargeCardGrid = styled.div`
  display: grid;
  grid-template-columns: repeat(auto-fit, minmax(320px, 1fr));
  gap: 1.5rem;
  margin-bottom: 2rem;
...
const FineStatisticsSkeleton = () => (
  <FineStatisticsSkeletonContainer>
    <SkeletonPageTitle />
    <SkeletonSmallCardGrid>
      <SkeletonStatCard />
      <SkeletonStatCard />
      <SkeletonStatCard />
      <SkeletonStatCard />
