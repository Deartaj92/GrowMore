...
# Set variables
$source = "D:\GrowMore"           # Change this to your actual project path if different
$timestamp = Get-Date -Format "dd-MMM-yy_hh-mm_tt"
$archive = "D:\ProjectBackup\GrowMore_backup_$timestamp.7z" # Backup filename with timestamp
