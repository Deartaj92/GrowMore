-- =====================================================
-- CLEANUP OLD AUDIT LOGS - KEEP ONLY LAST 100
-- =====================================================
-- This script keeps only the 100 most recent audit logs
...
-- 3. Find the cutoff timestamp (100th most recent log)
WITH ranked_logs AS (
    SELECT 
        id,
        changed_at,
...
-- 5. Perform the cleanup - Delete logs older than the 100th most recent
WITH ranked_logs AS (
    SELECT 
        id,
        changed_at,
...
BEGIN
    ...
    RAISE NOTICE '=====================================================';
    RAISE NOTICE 'Result: % audit logs remaining (last 100 records)', remaining_count;
